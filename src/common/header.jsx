            ...
            <article className='relative flex items-start justify-between py-5 pb-12 px-10 pr-24'>
                ...
                <div className='flex flex-col items-end justify-end'>
                    ...
                    <div className='flex flex-col gap-5 absolute top-14 pl-2 left-full items-center mt-2'>
                        ...
                        {techPackData.slides.find(slide => slide.page === page)?.type !== 'Information' && (
                            <div
                                onClick={() => {
                        ...
                        >
                            <svg width="18"
                                ...
                                <path d="M3 16V4C3 2.89543 3.89543 2 5 2H15M9 22H18C19.1046 22 20 21.1046 20 20V8C20 6.89543 19.1046 6 18 6H9C7.89543 6 7 6.89543 7 8V20C7 21.1046 7.89543 22 9 22Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </div>
                        <div
